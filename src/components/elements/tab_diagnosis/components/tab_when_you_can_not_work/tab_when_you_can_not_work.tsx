...
import {TabRight,Flex, DivBudget, Budget, LabelMoney, TextDetail, TextMoney, TextMoneyDesc, Button
} from "../../styled";
import {TabDiagnosisLeft} from "../tab_diagnosis_left";
import {TabDisable} from "../tab_disable/tab_disable";

export const TabWhenYouCanNotWork: React.FC<ITabWhenYouCanNotWorkProps> = (
  props
): JSX.Element => {
  const { data } = props;
  ...
  return (
    <Flex>
        <TabDiagnosisLeft title={'働けなくなった時'} image={images.whenYouCanNotWorkIcon}/>
