...
import {
    ...
    TextTitleDisable,
    FlexDiagnosis,
    Budget, FlexBudget, TextMoney, TextMoneyDesc, TextDetail
} from "../tab_diagnosis.styled";
import {Flex2} from "../tab_diagnosis.styled";
import {images} from "../../../../assets/images";

export const TabDiagnosisRight: React.FC<ITabDiagnosisRight> = (props): JSX.Element => {
    ...
    if (isDisable) {
        return (
            <DivDiagnosisDisable>
                <FlexDiagnosis>
                    <img width={'20px'} src={images.exclamationMarkIcon}/>
    ...
    return (
        <DivDiagnosisRight>
            <FlexBudget>
                {budget.map((item) => <Budget>{item}</Budget>)}
            </FlexBudget>
            <Flex2>
